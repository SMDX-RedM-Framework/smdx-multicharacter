    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                setTimeout(function(){
                    setCharactersList()
                    $.post('https://smdx-multicharacter/setupCharacters');
                    setTimeout(function(){
                        ...
                        $.post('https://smdx-multicharacter/removeBlur');
                    }, 2000);
                }, 2000);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('https://smdx-multicharacter/closeUI');
    $.post('https://smdx-multicharacter/disconnectButton');
});
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('https://smdx-multicharacter/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function (e) {
    ...
    $.post('https://smdx-multicharacter/createNewCharacter', JSON.stringify({
        cid: cid,
    }));
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://smdx-multicharacter/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('https://smdx-multicharacter/selectCharacter', JSON.stringify({
